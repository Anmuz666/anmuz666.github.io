<template >
  <div class="bk">
    <div class="content">
      <h1 class="enter" style=" text-shadow: 5px 5px 6px rgba(0, 0, 0, .6)">欢迎来到苟创中学</h1>
      <p
        class="enter"
        style=" text-shadow: 5px 5px 6px rgba(0, 0, 0, .6)"
      >GouChuang Middle School NingBo Branch</p>
      <span class="goto">
        <button @click="goto()">进入</button>
      </span>
    </div>
  </div>
</template>
